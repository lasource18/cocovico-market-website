...
<body>
    ...
    <br>
    <div class="jumbotron" id="dairy">
        <a href="#dairy" style="text-decoration: none; color: black;"><h1 class="text-center" id="show">Cocovico&nbsp;<i class="fas fa-shopping-basket"></i>&nbsp;Market</h1></a>
    </div>
